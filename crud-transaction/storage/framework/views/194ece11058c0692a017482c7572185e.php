...
$maxWidth = [
    ...
    'xl' => 'sm:max-w-xl',
    '2xl' => 'sm:max-w-2xl',
    '3xl' => 'sm:max-w-3xl', // Tambahkan ukuran baru
    '4xl' => 'sm:max-w-4xl', // Tambahkan ukuran lebih besar
    'full' => 'sm:max-w-screen-lg', // Modal hampir penuh layar
    'wide' => 'sm:max-w-screen-xl', // Modal lebih lebar
    'max' => 'sm:max-w-screen-2xl', // Modal super besar
][$maxWidth];
?>
...
<?php /**PATH /home/erzie-aldrian/Documents/newtronic/crud-transaction/resources/views/components/modal.blade.php ENDPATH**/ ?>