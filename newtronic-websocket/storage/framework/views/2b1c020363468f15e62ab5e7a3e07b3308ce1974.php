...
<div id="scoreBoard" class="bg-black rounded-xl shadow-2xl p-8 mb-8 cursor-pointer hover:bg-gray-900 transition-all">
    ...
    <div class="flex justify-between items-center">
        <div class="text-center flex-1">
            ...
            <h2 class="text-2xl font-bold text-white mb-2"><strong><?php echo e($game->team_a); ?></strong></h2>
            <div class="text-7xl font-bold text-white"><strong><?php echo e($game->score_a); ?></strong></div>
        </div>
        ...
        <div class="text-center flex-1">
            ...
            <h2 class="text-2xl font-bold text-white mb-2"><strong><?php echo e($game->team_b); ?></h2>
            <div class="text-7xl font-bold text-white"><strong><?php echo e($game->score_b); ?></strong></div>
        </div>
    </div>
</div>
    ...
    <div class="text-center w-full p-8">
        <div class="flex justify-between items-center max-w-6xl mx-auto">
            <div class="text-center flex-1">
                ...
                <h2 class="text-4xl font-bold text-white mb-4"><strong><?php echo e($game->team_a); ?></strong></h2>
                <div class="text-9xl font-bold text-white"><strong><?php echo e($game->score_a); ?></strong></div>
            </div>
            ...
            <div class="text-center flex-1">
                ...
                <h2 class="text-4xl font-bold text-white mb-4"><strong><?php echo e($game->team_b); ?></h2>
                <div class="text-9xl font-bold text-white"><strong><?php echo e($game->score_b); ?></strong></div>
            </div>
        </div>
    </div>
</div>
...
<div class="container mx-auto px-4 py-8">
    <div class="mt-6 bg-white rounded-lg shadow-md p-6">
        <form action="<?php echo e(url('/games/'.$game->id.'/score')); ?>" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="score_a" value="<?php echo e($game->score_a); ?>" class="w-full p-2 border rounded-md">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Team B Score</label>
                    <input type="number" name="score_b" value="<?php echo e($game->score_b); ?>" class="w-full p-2 border rounded-md">
                </div>
            </div>
        ...
        <!-- Form Edit Skor -->
        <a href="<?php echo e(route('public')); ?>" class="block mt-4 text-blue-600">Kembali ke Daftar Pertandingan</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/erzie-aldrian/Documents/newtronic/newtronic-websocket/resources/views/games/score-show.blade.php ENDPATH**/ ?>